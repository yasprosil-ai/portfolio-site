    ...
    <section id="top" className="relative min-h-[100dvh] w-full max-w-full overflow-x-hidden pt-20">
      ...
      <div className="mx-auto grid min-h-[calc(96dvh-5rem)] w-full max-w-7xl grid-cols-1 items-center gap-12 px-4 py-10 sm:px-6 lg:grid-cols-[minmax(0,1.12fr)_minmax(0,0.88fr)] lg:px-8 lg:py-14">
        <div className="min-w-0 max-w-full lg:max-w-4xl">
          ...
          <div className="hero-reveal mt-9 flex flex-col gap-3 sm:flex-row" style={{ "--hero-delay": "340ms" }}>
            <BriefModalTrigger
            ...
            >
              ...
              <ArrowUpRight size={18} className="hero-primary-arrow" />
            </BriefModalTrigger>
            <a
              href="#projects"
          ...
          <div className="hero-reveal mt-8 flex max-w-full flex-wrap gap-2 text-sm text-slate-300" style={{ "--hero-delay": "430ms" }}>
            {[
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {[
                  ...
                  <div
                    ...
                    style={{ "--card-delay": `${620 + index * 90}ms` }}
                  >
