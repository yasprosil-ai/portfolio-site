      ...
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.88fr_1.12fr] lg:items-start">
        ...
        <div className="grid gap-6">
          <div className="space-y-5 text-base leading-8 text-slate-300">
            <p>
              Я создаю сайты, Telegram-ботов, мини-приложения и MVP с помощью современных AI-инструментов.
              Мой фокус — быстро собрать понятную рабочую версию, которую можно показать клиентам,
              протестировать и улучшать дальше.
            </p>
            <p>
